...
def train_classifier():
    images_filepath ='/home/raphael/Documents/Team19_Final/2022Fimgs/'#'/home/ymhaskar/VisionFollowing/2022Fimgs/' # TESTING ON 2022Fimgs
    labels_filepath = '/home/raphael/Documents/Team19_Final/2022Fimgs/labels2.csv'

    classifier_filepath = '/home/raphael/Documents/Team19_Final/classifier.pkl'
    ...
    hog_features_test = [extract_hog_features(image).reshape(-1) for image in data_test_cropped]

    # Feature extraction using HOG skewness
    skewness_features_test = [compute_hog_skewness(image) for image in data_test_cropped]
