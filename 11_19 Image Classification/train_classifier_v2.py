...
def contour_extraction(path):
    ...
    image_filepath = '/home/michaelangelo/Documents/Team19_image_classifier-master/2023Simgs/S2023_imgs/015.png'
    ...
    cv2.waitKey(0)
    cv2.imshow('CHAIN_APPROX_SIMPLE Point only', frame_threshold)
